...
const Login = ({handleLogin}) => {
  ...
  return (
    <div className='flex h-screen w-screen items-center justify-center'>
        ...
        <p><strong>Admin:</strong> admin@me.com | Password: 123</p>
        <p><strong>Employees:</strong> employee1@me.com, employee2@me.com, employee3@me.com, employee4@me.com, employee5@me.com | Password: 123</p>
      </div>
        </div>
